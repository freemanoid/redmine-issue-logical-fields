  ...
  module InstanceMethods
    def value_with_compare_type(issue)
      if @cf.field_format == 'compare'
        ...
        first_date = issue.custom_values.where(custom_field_id: @cf.first_date_id).first.value
        second_date = issue.custom_values.where(custom_field_id: @cf.second_date_id).first.value
